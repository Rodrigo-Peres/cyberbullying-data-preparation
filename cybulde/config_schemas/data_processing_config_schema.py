...
class DataProcessingConfig:
    ...
    dvc_remote_repo: str = "https://github.com/Rodrigo-Peres/cybulde-data.git"
    dvc_data_folder: str = "data/raw"
    github_user_name: str = "Rodrigo-Peres"
    github_access_token_secret_id: str = "cyberbullying-github-access"
